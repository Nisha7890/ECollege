...
public class Bim8th extends AppCompatActivity {

    public RecyclerView recyclerView;
    public RecyclerView.Adapter adapter;
    public RecyclerView.LayoutManager layoutManager;

    ArrayList<Bim8thDataList> arrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bim8th);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.bim8th);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0; i< jsonArray.length();i++){
                        ...
                        Bim8thDataList bim8thDataList = new Bim8thDataList(year,id);
                        arrayList.add(bim8thDataList);
                    }
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        ArrayList<Bim8thDataList> newArrayList;
        Context context;

        public MyAdapter(ArrayList<Bim8thDataList> arrayList, Context applicationContext) {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.popupbim8thyear,parent,false);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            final Bim8thDataList bim8thDataList = newArrayList.get(position);
            holder.year.setText(bim8thDataList.getYear());

            holder.year.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(final View view) {

                    AlertDialog.Builder builder = new AlertDialog.Builder(Bim8th.this);
                    ...
                    final String url = "http://nepalidolconcert.com/demo/intern/api/questions" + "/" + 1 + "/" + 13 + "/" + bim8thDataList.getId() + "/" + id;
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                if(jsonArray !=null && jsonArray.length() >0) {
                                    ...
                                    final Bim8thDataList bim8thDataList = new Bim8thDataList(question);
                                    arrayList.add(bim8thDataList);
                                    ...
                                    imageView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            downloadFile(bim8thDataList.getQuestion());
                                        }
                                    });
                                    ...
                                    textView.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            getQuestionView(bim8thDataList.getQuestion());
                                        }
                                    });
        ...
        public class  ViewHolder extends RecyclerView.ViewHolder{
            ...
            public ViewHolder(View itemView) {
                ...
                year = (TextView)itemView.findViewById(R.id.bim8thyear);
            }
        }
    }
    ...
    private void downloadFile(String questionsurl) {
        ...
        if (ActivityCompat.checkSelfPermission(Bim8th.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(Bim8th.this,
